...
if __name__ == '__main__':
    ...
    activation = 'relu'
    layer_num = 6  # 交叉层的数量
    reg_w = 1e-4 # 各层权重wl的L2正则化系数
    reg_b = 1e-4 # 各层偏置bl的L2正则化系数
